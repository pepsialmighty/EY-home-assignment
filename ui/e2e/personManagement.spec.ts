...
test('edit a person and verify updated name in list', async ({ page, request }) => {
...
test('delete a person and verify they are removed from the list', async ({ page, request }) => {
  await request.post('http://localhost:5000/api/people', {
